...
<body>
	<div id="wrap">
		<div class="container">
			...
			<table class="table table-striped">
				...
				<tr>
					<td>Nginx</td>
					<td><?php echo (isset($_SERVER['SERVER_SOFTWARE']) ? str_replace('nginx/', '', $_SERVER['SERVER_SOFTWARE']) : 'N/A'); ?></td>
				</tr>
	...
	<div id="footer">
		<div class="container">
			<p class="muted credit"><a href="https://github.com/tonicospinelli/vagrant-lnmp.git" target="_blank">Vagrant LNMP</a> by <a href="https://github.com/tonicospinelli" traget="_blank">Antonio Spinelli</a>.</p>
		</div>
	</div>
</body>
</html>
